    ...
    <div class="lg:col-span-9 col-span-12 border border-gray-400">
      ...
      <div class="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 px-10 py-4 lg:py-8 gap-x-4 gap-y-4">
        ...
        <div>
          ...
          <br />
          <span>{{ data.ppl.type }}</span>
        </div>
        <!-- <div class="lg:block hidden"></div> -->
        <div>
          <span class="font-bold">Category</span>
          <br />
          <span>{{ data.ppl.category }}</span>
        </div>
        <div>
          <span class="font-bold">Product</span>
          <br />
          <span>{{ data.ppl.product }}</span>
        </div>
        <div>
          <span class="font-bold">Property Type</span>
          <br />
          <span>{{ data.ppl.propertyType }}</span>
        </div>
        <div>
          <span class="font-bold">Amount Required</span>
          <br />
          <span>${{ numberWithCommasHandler(data.ppl.loanAmount) }}</span>
        </div>
        <div>
          <span class="font-bold">Repayment Period</span>
          <br />
          <span>{{ data.ppl.loanPeriod }}</span>
        </div>
        <div class="sm:col-span-2">
          <div class="font-bold">Remarks</div>
          <div>{{ data.ppl.remarks }}</div>
        </div>
        <div>
    ...
    <div class="lg:col-span-3 col-span-12 px-10 sm:py-0 py-4 lg:py-8 border border-gray-400">
      <div class="grid grid-rows-5 grid-flow-col">
        ...
        <div class="pb-4">
          ...
          <br />
          <span>{{ data.ppl.customerNationality }}</span>
        </div>
        <!-- <div class="pb-4">
          ...
          <span >
            {{
            data.ppl.customerResidenceStatus
            }}
          </span>
        </div>-->
        <div class="pb-4">
          ...
          <br />
          <span>
            {{ data.ppl.customerEmploymentStatus }}
          </span>
        </div>
        <div class="pb-4">
          ...
          <br />
          <span>
            {{ findDaysAgoHandler(data.ppl.customerEmploymentDate) }}
          </span>
        </div>
        <!-- <div class="pb-4">
          ...
          <span >
            {{
            data.ppl.customerEmploymentIncome
            }}
          </span>
        </div>-->
      </div>
