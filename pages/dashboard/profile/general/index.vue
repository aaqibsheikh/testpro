<template>
  <div class="w-full">
    <Header />
    <EditGeneralProfile :userProfile="userProfile" :baitSettings="baitSettings" />
  </div>
</template>
<script>
...
export default {
  ...
  async fetch({ app, params, store }) {
    ...
    await store.dispatch('profile/getGeneralProfile');
  },
  computed: {
    ...mapGetters({
      userProfile: 'profile/isGeneralProfile',
